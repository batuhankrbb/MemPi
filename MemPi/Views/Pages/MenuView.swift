...
class MenuView:UIView{
    ...
    private func configureUI(){
        ...
        appLogo.anchor(top: safeAreaLayoutGuide.topAnchor, leading: nil, bottom: nil, trailing: nil,padding: .init(top: 40, left: 0, bottom: 0, right: 0))
        
        let buttonStackView = UIStackView(arrangedSubviews: [challangeButton,trainingButton,digitsButton])
        ...
        buttonStackView.anchor(top: appLogo.bottomAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor,padding: .init(top: 35, left: 20, bottom: 0, right: 20))
        ...
        coinShow.anchor(top: buttonStackView.bottomAnchor, leading: nil, bottom: nil, trailing: nil,padding: .init(top: bounds.size.height / 22, left: 0, bottom: 0, right: 0))
        ...
        soundStack.anchor(top: nil, leading: nil, bottom: safeAreaLayoutGuide.bottomAnchor, trailing: nil,padding: .init(top: 0, left: 0, bottom: 12, right: 0))
    }
